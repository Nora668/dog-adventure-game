...
public:
	 ...
	 * the hard)
	 *
	 * So that's the walls. Then I added the 'D' to the beginning square and an 'E' to the end
	 square.
	 *
	 *
	 */
	 ...
	 *
	 * This method prints out the board such that it looks like a board. It prints a blank space
	 ...
	 * I placed an -> arrow (thats a minus and a greater than sign) in the border for where the
